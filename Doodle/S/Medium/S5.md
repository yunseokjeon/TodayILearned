1 https://leetcode.com/problems/unpopular-books/
...
```
2 https://leetcode.com/problems/new-users-daily-count/
```SQL
/*
...
group by login_date
```
3 https://leetcode.com/problems/highest-grade-for-each-student/
```SQL
/*
...
ORDER BY student_id
```
4 https://leetcode.com/problems/active-businesses/
```SQL
/*
...
```
5 https://leetcode.com/problems/reported-posts-ii/
```SQL
/*
